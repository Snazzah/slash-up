...
arr = futureChangelog
  ...
  .map((line) =>
    line.startsWith('[Unreleased]')
      ? `[Unreleased]: https://github.com/Snazzah/slash-up/compare/v${currentVersion}...HEAD`
      : line
  );
...
const lastLine = `[${currentVersion}]: https://github.com/Snazzah/slash-up/compare/v${lastVersion}...v${currentVersion}`;
